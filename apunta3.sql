...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-12-2017 a las 14:03:10
...
(14, 'andrea', 'andrea', 'andrea@gmail.com'),
(15, 'pepep', 'pepep', 'pepep@gmail.com');
...
--
ALTER TABLE `nota`
  MODIFY `IdNota` bigint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
--
-- AUTO_INCREMENT de la tabla `usuario`
--
ALTER TABLE `usuario`
  MODIFY `IdUsuario` bigint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
